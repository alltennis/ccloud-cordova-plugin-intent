...
[![npm version](http://img.shields.io/npm/v/com-ccloud-cordova-plugin-intent.svg?style=flat-square)](https://npmjs.org/package/com-ccloud-cordova-plugin-intent "View this project on npm")
[![npm downloads](http://img.shields.io/npm/dm/com-ccloud-cordova-plugin-intent.svg?style=flat-square)](https://npmjs.org/package/com-ccloud-cordova-plugin-intent "View this project on npm")
[![npm downloads](http://img.shields.io/npm/dt/com-ccloud-cordova-plugin-intent.svg?style=flat-square)](https://npmjs.org/package/com-ccloud-cordova-plugin-intent "View this project on npm")
[![npm licence](http://img.shields.io/npm/l/com-ccloud-cordova-plugin-intent.svg?style=flat-square)](https://npmjs.org/package/com-ccloud-cordova-plugin-intent "View this project on npm")
...
# Android X support
- For Android X Support please use version >= [2.x.x](https://www.npmjs.com/package/com-ccloud-cordova-plugin-intent/v/2.0.0) 
- For Android Support Library please use version [1.3.x](https://www.npmjs.com/package/com-ccloud-cordova-plugin-intent/v/1.3.0)
...
- https://github.com/Initsogar/cordova-webintent.git (no longer available on github but the project is forked here: https://github.com/ccloud/cordova-webintent)
...
## Testing / Example
An example application is available at https://github.com/ccloud/plugin-intent-api-exerciser to demonstrate the API and can be used to test the functionality.

## Installation

### Cordova Version < 7
    cordova plugin add https://github.com/ccloud/ccloud-cordova-plugin-intent.git

### Cordova Version >= 7
    cordova plugin add com-ccloud-cordova-plugin-intent

## Use with PhoneGap

Please use the latest PhoneGap cli when including this plugin, please refer to [Issue 63](https://github.com/ccloud/ccloud-cordova-plugin-intent/issues/63) for context. 
...
Register a broadcast receiver for two filters:
    ...
    window.plugins.intentShim.registerBroadcastReceiver({
        filterActions: [
            'com.ccloud.cordova.plugin.broadcastIntent.ACTION',
            'com.ccloud.cordova.plugin.broadcastIntent.ACTION_2'
            ]
        },
        function(intent) {
...
Send a broadcast intent to a specified action that contains a random number in the extras
    ...
    window.plugins.intentShim.startActivity(
        {
            action: "com.ccloud.cordova.plugin.intent.ACTION",
            extras: {
